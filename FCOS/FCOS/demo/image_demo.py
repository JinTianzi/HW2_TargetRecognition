...
def parse_args():
    ...
    parser.add_argument(
        '--inputs', default = r'C:\Users\Administrator\Desktop\test',type=str, help='Input image file or folder path.')
    parser.add_argument(
        '--model',
        #default='configs/fcos/fcos_r50-caffe_fpn_gn-head_1x_voc.py',
        default=r'configs/fcos/fcos_r50-caffe_fpn_gn-head_1x_voc.py',
        type=str,
        help='Config or checkpoint .pth file or the model name '
        'and alias defined in metafile. The model configuration '
        'file will try to read from .pth if the parameter is '
        'a .pth weights file.')
    parser.add_argument('--weights', default='work_dirs/fcos_r50-caffe_fpn_gn-head_1x_voc/epoch_12.pth', help='Checkpoint file')
    parser.add_argument(
        '--out-dir',
        type=str,
        default='outputs',
